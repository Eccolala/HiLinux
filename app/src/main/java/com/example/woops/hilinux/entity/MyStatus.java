...
public class MyStatus {
    ...
    private User user;
    private MyStatus retweeted_status;
    ...
    public MyStatus getRetweeted_status() {
        return retweeted_status;
    }

    public void setRetweeted_status(MyStatus retweeted_status) {
    ...
    public boolean equals(Object o) {
        if (o instanceof MyStatus) {
            return this.id == ((MyStatus) o).id;
        }
